...
def init_db():
    ...
    DEFAULT_CMS_PAGES = [
        ("homepage-hero", "Homepage Hero Banner", "<h1>High-Authority Backlink Vault &amp; Automated Domain Auditor</h1><p>Discover, analyze, and track high-DA DoFollow backlinks with automated inspection and Ubersuggest SEO metrics.</p>"),
